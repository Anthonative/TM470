...
${OBJECTDIR}/Instruction.o: Instruction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Instruction.o Instruction.cpp

${OBJECTDIR}/InstructionManager.o: InstructionManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InstructionManager.o InstructionManager.cpp

${OBJECTDIR}/LocalOut.o: LocalOut.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LocalOut.o LocalOut.cpp
